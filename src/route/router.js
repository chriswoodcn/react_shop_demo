                ...
                <Router>
                    <React.Fragment>
                        <Switch>
                            ...
                            <AuthRoute path={config.path + "balance/index"} component={BalanceIndex}/>
                            <AuthRoute path={config.path + "address/index"} component={AddressIndex}/>
                            <AuthRoute path={config.path + "address/add"} component={AddressAdd}/>
                            <AuthRoute path={config.path + "address/mod"} component={AddressMod}/>
                            <AuthRoute path={config.path + "balance/end"} component={BalanceEnd}/>
                            <AuthRoute path={config.path + "profile/index"} component={ProfileIndex}/>
                            <AuthRoute path={config.path + "myorder"} component={MyOrder}/>
                            <AuthRoute path={config.path + "order/detail"} component={OrderDetail}/>
                            <AuthRoute path={config.path + "order/add_review"} component={AddReview}/>
                            <AuthRoute path={config.path + "user/address/index"} component={UserAddressIndex}/>
                            <AuthRoute path={config.path + "user/address/mod"} component={UserAddressMod}/>
                            <AuthRoute path={config.path + "user/mobile/index"} component={UserMobileIndex}/>
                            <AuthRoute path={config.path + "user/modpwd/index"} component={UserModpwdIndex}/>
                            <AuthRoute path={config.path + "user/myfav/index"} component={MyFav}/>
