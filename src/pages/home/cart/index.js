                                ...
                                return (
                                    <div className={Css['cart-list']} key={index}>
                                        <div
                                            ...
                                            onClick={this.checkItem.bind(this, index, !item.checked)}/>
                                        <div className={Css['image-wrap']}>
                                            <div className={Css['image']}><img src={item.img} alt={item.title}/></div>
                                            <div className={Css['del']} onClick={this.delItem.bind(this, index)}>删除
                                            </div>
                                        </div>
                                        <div className={Css['goods-wrap']}>
                                            ...
                                            <div className={Css['buy-wrap']}>
                                                ...
                                                <div className={Css["amount-input-wrap"]}>
                                                    <div
                                                        className={this.props.state.cart.aCartData[index].amount > 1 ? Css['btn'] + " " + Css['dec'] : Css['btn'] + " " + Css['dec'] + " " + Css["active"]}
                                                        onClick={this.decAmount.bind(this, index)}>-
                                                    </div>
                                                    <div className={Css['amount-input']}><input type="tel"
                                                                                                value={item.amount}
                                                                                                onChange={(e) => {
                ...
                <div className={Css['orderend-wrap']}>
                    <div className={Css['select-area']}>
                        <div className={Css['select-wrap']}
                             onClick={this.setAllChecked.bind(this, !this.state.bAllChecked)}>
                            <div
                    ...
                    <div
                        className={this.props.state.cart.total > 0 ? Css['orderend-btn'] : Css['orderend-btn'] + " " + Css['disable']}
                        onClick={this.goBalance.bind(this)}>去结算
                    </div>
                </div>
            </div>
        );
