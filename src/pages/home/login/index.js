    ...
    render() {
        return (
            <div className={Css['page']}>
                <SubHeaderComponent title="会员登录"/>
                <div className={Css['main'] + " login-main"}>
                    <div className={Css['code-wrap']} style={{marginTop: "0px"}}><input type="text" placeholder="手机号"
                                                                                        onChange={(e) => {
                                                                                            this.setState({sCellphone: e.target.value})
                                                                                        }}/></div>
                    <div className={Css['password-wrap']}>
                        <div className={Css['password']}><input type={this.state.sType} placeholder="密码"
                                                                onChange={(e) => {
                    ...
                    <div className={Css["fastreg-wrap"]}>
                        ...
                        <div onClick={this.pushPage.bind(this, 'reg/index')}><img
                            src={require("../../../assets/images/home/index/reg.png")} alt="忘记密码"/> 快速注册
                        </div>
                    </div>
                </div>
            </div>
