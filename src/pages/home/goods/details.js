            ...
            <div>
                <div className={Css['details-header']}>
                    ...
                    <div className={Css['tab-wrap']}>
                        <div
                            className={this.state.tabStyle.bItem ? Css['tab-name'] + " " + Css['active'] : Css['tab-name']}
                            onClick={this.replacePage.bind(this, 'goods/details/item?gid=' + this.state.gid + '')}>商品
                        </div>
                        <div
                            className={this.state.tabStyle.bContent ? Css['tab-name'] + " " + Css['active'] : Css['tab-name']}
                            onClick={this.replacePage.bind(this, 'goods/details/content?gid=' + this.state.gid + '')}>详情
                        </div>
                        <div
                            className={this.state.tabStyle.bReviews ? Css['tab-name'] + " " + Css['active'] : Css['tab-name']}
                            onClick={this.replacePage.bind(this, 'goods/details/reviews?gid=' + this.state.gid + '')}>评价
                        </div>
                    </div>
                    <div id="cart-icon" className={Css['cart-icon']} onClick={this.pushPage.bind(this, 'home/cart')}>
                        <div
                            className={this.props.state.cart.aCartData.length > 0 ? Css['spot'] : Css['spot'] + " hide"}/>
                    </div>
                </div>
                <div className={Css['sub-page']}>
                    <Switch>
                        ...
                        <Route path={config.path + "goods/details/reviews"} component={DetailsReviews}/>
