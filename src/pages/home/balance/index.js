                ...
                <div className={Css['main']}>
                    <div className={Css['address-wrap']} onClick={this.replacePage.bind(this, 'address/index')}>
                            ...
                            sessionStorage['addressId'] !== undefined || localStorage['addressId'] !== undefined ?
                                <React.Fragment>
                                    ...
                                    <div className={Css['address']}>
                                        <img src={require("../../../assets/images/home/cart/map.png")}
                                             alt="收货地址"/><span>{this.state.sProvince}{this.state.sCity}{this.state.sArea}{this.state.sAddress}</span>
                                    </div>
                                </React.Fragment>
                                :
                        ...
                        <div className={Css['address-border-wrap']}>
                            <div className={Css['trapezoid'] + " " + Css['style1']}/>
                            <div className={Css['trapezoid'] + " " + Css['style2']}/>
                            <div className={Css['trapezoid'] + " " + Css['style1']}/>
                            <div className={Css['trapezoid'] + " " + Css['style2']}/>
                            <div className={Css['trapezoid'] + " " + Css['style1']}/>
                            <div className={Css['trapezoid'] + " " + Css['style2']}/>
                                    ...
                                    return (
                                        item.checked ?
                                            <div className={Css['goods-list']} key={index}>
                                                <div className={Css['image']}><img src={item.img} alt={item.title}/>
                                                </div>
