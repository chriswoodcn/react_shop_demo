...
class MyFav extends React.Component {
    ...
    componentDidMount() {
        document.getElementById('title').innerHTML = '我的收藏'
        setScrollTop()
        this.getData();
    }
                            ...
                            this.state.aGoods.map((item, index) => {
                                return (
                                    <div className={Css['goods-list']} key={index}>
                                        <div className={Css['image']}><img alt={item.title} data-echo={item.image}
                                        ...
                                        <div className={Css['btn-wrap']}>
                                            <div className={Css['btn']}
                                                 onClick={this.pushPage.bind(this, 'goods/details/item?gid=' + item.gid)}>购买
                                            </div>
                                            <div className={Css['btn']}
                                                 onClick={this.delFav.bind(this, index, item.fid)}>删除
                                            </div>
                                        </div>
                                    </div>
                                )
