...
class ProfileIndex extends React.Component {
    ...
    componentDidMount() {
        document.getElementById('title').innerHTML = '个人资料'
        this.getUserInfo();
    }
    ...
    render() {
        return (
            <div className={Css['page']}>
                <SubHeaderComponent title="个人资料" right-text="保存" onClickRightBtn={this.submitSave.bind(this)}/>
                <div className={Css['main']}>
                    <ul className={Css['head']}>
                        <li>头像</li>
                        <li><img src={this.state.sHead} alt=""/><input ref="headfile" type="file"
                                                                       onChange={this.uploadHead.bind(this)}/></li>
                    </ul>
                    ...
                    <ul className={Css['list']}>
                        <li>性别</li>
                        <li><input type="text" placeholder="请选择性别" readOnly onClick={this.selectGender.bind(this)}
                                   value={this.state.sGender}/></li>
                        <li className={Css['arrow']}/>
                    </ul>
                </div>
            </div>
