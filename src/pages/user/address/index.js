...
class UserAddressIndex extends React.Component {
    ...
    componentDidMount() {
        document.getElementById('title').innerHTML = '收货地址'
        setScrollTop();
        this.getData();
    }
    ...
    render() {
        return (
            <div className={Css['page']}>
                <SubHeaderComponent title="收货地址管理"/>
                            ...
                            this.state.datas.map((item, index) => {
                                return (
                                    <div className={Css['list']} key={index}
                                         onClick={this.pushPage.bind(this, 'user/address/mod?aid=' + item.aid)}>
