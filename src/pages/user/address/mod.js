    ...
    render() {
        return (
            <div className={Css['page']}>
                <SubHeaderComponent title="修收货地址" right-text="删除" onClickRightBtn={this.delData.bind(this)}/>
                <div className={Css['main']}>
                    ...
                    <ul>
                        ...
                        >
                            <li>
                                <input type="text" placeholder="请选择收货地址" className={Css['area']} readOnly
                    ...
                    <button type="button" className={Css['submit-save']} onClick={this.submitData.bind(this)}>修改
                    </button>
                </div>
            </div>
        );
